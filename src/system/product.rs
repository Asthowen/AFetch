...
pub fn get_product(
    ...
    Ok(InfoResult::Single(InfoGroup {
        values: filtered_values!(
            fields,
            [
                (InfoField::ProductFamily, Product::family()),
                ...
                (InfoField::ProductSerialNumber, Product::serial_number()),
                (
                    InfoField::ProductStockKeepingUnit,
                    Product::stock_keeping_unit()
                ),
                (InfoField::ProductUuid, Product::uuid()),
                (InfoField::ProductVendorName, Product::vendor_name()),
                (InfoField::ProductVersion, Product::version()),
            ]
        ),
    }))
}
